...
<html lang="en">
    <head>
        ...
        <title>ONEYES_C++_INTRODUCTION</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 10) {
                    echo '
                    <a href="#" class="active">Inroduction to C++<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="C++.php" class="active">Inroduction to C++<br><span class="small">Completed</span></a>';
                }
                if ($progress < 20) {
                    echo '
                    <a href="#">Basics of C++</a>
                    ';
                } else {
                    // Display the "Next" button
        ...
        <div class="main">
        <h1 class="chead">C++ </h1>
        <h2 class="subhead">Introduction to C++ :</h2>
        <p class="high">What is C++ ?</p>
                
        <p class="ccontent">Arthur Samuel, an early American leader in the field of computer gaming and artificial intelligence, coined the term “C++  ” in 1959 while at IBM. He defined C++  as “the field of study that gives computers the ability to learn without being explicitly programmed “. However, there is no universally accepted definition for C++ . Different authors define the term differently. We give below two more definitions.</p>
        ...
        <li class="clist">C++  is programming computers to optimize a performance criterion using example data or past experience. We have a model defined up to some parameters, and learning is the execution of a computer program to optimize the parameters of the model using the training data or past experience. The model may be predictive to make predictions in the future, or descriptive to gain knowledge from data.</li>
        <li class="clist">The field of study known as C++  is concerned with the question of how to construct computer programs that automatically improve with experience.</li>
        
        <p class="ccontent">C++  is a subfield of artificial intelligence that involves the development of algorithms and statistical models that enable computers to improve their performance in tasks through experience. These algorithms and models are designed to learn from data and make predictions or decisions without explicit instructions.</p>
        <p class="ccontent"> There are several types of C++ , including supervised learning, unsupervised learning, and reinforcement learning. Supervised learning involves training a model on labeled data, while unsupervised learning involves training a model on unlabeled data. Reinforcement learning involves training a model through trial and error. C++  is used in a wide variety of applications, including image and speech recognition, natural language processing, and recommender systems.</p>
        ...
        <iframe class="cvideo" src="https://www.youtube.com/embed/-DEL6SVRPw0"></iframe>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 10) {
                    ...
                    // Display the "Next" button
                    echo '<a href="C++_Basics.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
