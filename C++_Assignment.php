...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: C++_Complete.php");
        exit();
    } else {
        // Handle the error
...
if (isset($_POST['inputValue'])) {
    ...
    $user_id = $_SESSION['user_id'];
    $course_id = 2; // Change this to the appropriate course ID
...
<html lang="en">
    <head>
        ...
        <title>ONEYES_C++_ASSIGNMENT</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 90) {
                    ...
                    // Display the "Next" button
                    echo '<a href="C++_Assignment.php" class="active">Assignment<br><span class="small">Completed</span></a>';
                }
        ...
        <div class="nbutton">
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 90) {
                    ...
                    // Display the "Next" button
                    echo '<a href="C++_Complete.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
...
<script>
        const quizDatabase = [
    {
        ...
        a : " Machine Learning (C++) is that field of computer science",
        b : " C++ is a type of artificial intelligence that extract patterns out of raw data by using an algorithm or method.",
        c : "All of the above",
        d : "The main focus of C++ is to allow computer systems learn from experience without being explicitly programmed or human intervention.",
        ans : "ans3"
    },
    {
        question : "Q2. C++ is a field of AI consisting of learning algorithms that?",
    ...
    {
        question : "Q8.  In Model based learning methods, an iterative process takes place on the C++ models that are built based on various model parameters, called ?",
        a : "mini-batches",
    ...
    {
        question : "Q9. Which of the following are C++ methods?",
        a : "Which of the following are C++ methods?",
