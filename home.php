        ...
        <header>
            <nav>
                ...
                <ul id="nav-bar">
                    ...
                    <li>
                        <a href="OneYes_lms.php" class="active1">Continue</a>
                    </li>
                </ul>
            </nav>
...
if (mysqli_num_rows($select) > 0) {
    ...
    if (!empty($fetch['image'])) {
        ...
        echo '<img src=" https://th.bing.com/th/id/OIP.GJrlZfzC1waiU0Ol25L5aAHaFJ?pid=ImgDet&rs=1" alt="User Image">';
    } else {
        echo '<img src="https://th.bing.com/th/id/OIP.GJrlZfzC1waiU0Ol25L5aAHaFJ?pid=ImgDet&rs=1" alt="Default Avatar">';
    }
} else {
    echo 'User not found';
}
?>
      ...
      <a href="OneYes_lms.php?logout=<?php echo $user_id; ?>" class="delete-btn">Continue</a>
