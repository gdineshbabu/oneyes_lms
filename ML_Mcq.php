...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: ML_Assignment.php");
        exit();
    } else {
        // Handle the error
...
<html lang="en">
    <head>
        ...
        <title>ONEYES_ML_DISADVANTAGES</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
...
<!-- Stylesheet -->
    ...
    <body>
        <header>
            <nav>
                ...
                <ul id="nav-bar">
                    ...
                    <li>
                        <?php
                        $select = mysqli_query($conn, "SELECT * FROM `user_form` WHERE id = '$user_id'") or die('query fMLled');
        ...
        $user_id = $user_id; 
        $course_id = 10; 
        $selected = mysqli_query($conn, "SELECT * FROM `user_course` WHERE user_id = '$user_id' AND course_id = '$course_id'") or die('query fMLled');
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 80) {
                    echo '
                    <a href="#" class="active">ML DisAdvantages<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="ML_Mcq.php" class="active">ML DisAdvantages<br><span class="small">Completed</span></a>';
                }
                if ($progress < 90) {
                    echo '
                    <a href="#">Assignment</a>
        ...
        <h2 class="subhead">Advantages of Machine Learning(ML) :</h2> <br>
        
        <li class="clist">1. <span class="high">Easily identifies trends and patterns</span></li>
        <li class="clist">2. <span class="high">No human intervention needed (automation)</span></li>
        <li class="clist">3. <span class="high">Continuous Improvement</span></li>
        <li class="clist">4. <span class="high">Handling multi-dimensional and multi-variety data</span></li>
        <li class="clist">5. <span class="high">Wide Applications</span></li>
        
        <img src="https://electricalfundablog.com/wp-content/uploads/2020/01/Advantages-and-Disadvantages-of-Machine-Learning.png" alt="ML" class="cimg1">
        <h2 class="subhead">DisAdvantages of Machine Learning(ML) :</h2> <br>
        <li class="clist">1. <span class="high">Data Acquisition</span></li>
        <li class="clist">2. <span class="high">Time and Resources</span></li>
        <li class="clist">3. <span class="high">Interpretation of Results</span></li>
        <li class="clist">4. <span class="high">High error-susceptibility</span></li>
        


        
        <p class="ccontent1"><b>Video Reference :  </b></p>
        <iframe class="cvideo" src="https://www.youtube.com/embed/kJqg1HvnRss"></iframe>
            <div class="nbutton">
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 80) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_Assignment.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
