    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 50) {
                    echo '
                    <a href="#" class="active">History of ML<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="ML_History.php" class="active">History of ML<br><span class="small">Completed</span></a>';
                }
        ...
        <h2 class="subhead">History of ML :</h2>

        <p class="ccontent">Machine learning (ML) is an important tool for the goal of leveraging technologies around artificial intelligence. Because of its learning and decision-making abilities, machine learning is often referred to as AI, though, in reality, it is a subdivision of AI. Until the late 1970s, it was a part of AI’s evolution. Then, it branched off to evolve on its own. Machine learning has become a very important response tool for cloud computing and e-commerce, and is being used in a variety of cutting-edge technologies. Below is a brief history of machine learning and its role in data management.</p>
        
        <img src="https://th.bing.com/th/id/OIP.B3AF27rcFBRdMhMnymew2wHaOs?pid=ImgDet&w=1280&h=2540&rs=1" alt="AI" class="cimg1">
        
        <p class="ccontent">Machine learning is a necessary aspect of modern business and research for many organizations today. It uses algorithms and neural network models to assist computer systems in progressively improving their performance. Machine learning algorithms automatically build a mathematical model using sample data – also known as “training data” – to make decisions without being specifically programmed to make those decisions.</p>
        <p class="ccontent">Machine learning is, in part, based on a model of brain cell interaction. The model was created in 1949 by Donald Hebb in a book titled “The Organization of Behavior.” The book presents Hebb’s theories on neuron excitement and communication between neurons.</p>
        ...
        <iframe class="cvideo" src="https://www.youtube.com/embed/m_nQM_AkVfY"></iframe>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 50) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_Goals.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
