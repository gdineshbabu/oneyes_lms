...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: DS_OverView.php");
        exit();
    } else {
        // Handle the error
...
<htDS lang="en">
    <head>
        ...
        <title>ONEYES_DS_COMPLETED</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    echo '
                    <a href="#" class="active">Complete DS<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="DS_Complete.php" class="active">Complete DS<br><span class="small">Completed</span></a>';
                }
                if ($progress < 100) {
                    echo '
                    <a href="#">Over View</a>
...
Congratulations 💐
        ...
        <h1 class="course">DATA SCIENCE</h1>
        ...
        <p class="quote">"Life itself is your teacher, and you are in a state of constant learning."</p>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    ...
                    // Display the "Next" button
                    echo '<a href="DS_OverView.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
