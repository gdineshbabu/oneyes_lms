    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 20) {
                    echo '
                    <a href="#" class="active">Basics of ML<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="ML_Basics.php" class="active">Basics of ML<br><span class="small">Completed</span></a>';
                }
                if ($progress < 30) {
                    echo '
        ...
        <h2 class="subhead">Basics to ML :</h2>
        <p class="high">Definition of Machine:</p>
        <li class="clist">Machine learning is a subfield of artificial intelligence that involves the development of algorithms and statistical models that enable computers to improve their performance in tasks through experience. These algorithms and models are designed to learn from data and make predictions or decisions without explicit instructions. </li>
        <li class="clist"> There are several types of machine learning, including supervised learning, unsupervised learning, and reinforcement learning. Supervised learning involves training a model on labeled data, while unsupervised learning involves training a model on unlabeled data. Reinforcement learning involves training a model through trial and error. Machine learning is used in a wide variety of applications, including image and speech recognition, natural language processing, and recommender systems.</li>
        ...
        <p class="ccontent"><span class="high">Definition :  </span>A computer program which learns from experience is called a machine learning program or simply a learning program . </p>
        ...
        <iframe class="cvideo" src="https://www.youtube.com/embed/ukzFI9rgwfU"></iframe>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 20) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_Types.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
