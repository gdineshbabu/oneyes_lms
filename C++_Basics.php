    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 20) {
                    echo '
                    <a href="#" class="active">Basics of C++<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="C++_Basics.php" class="active">Basics of C++<br><span class="small">Completed</span></a>';
                }
                if ($progress < 30) {
                    echo '
                    <a href="#">Types of C++</a>
        ...
        <div class="main">
        <h1 class="chead">C++</h1>
        <h2 class="subhead">Basics to C++ :</h2>
        <p class="high">Definition of Machine:</p>
        <li class="clist">C++ is a subfield of artificial intelligence that involves the development of algorithms and statistical models that enable computers to improve their performance in tasks through experience. These algorithms and models are designed to learn from data and make predictions or decisions without explicit instructions. </li>
        <li class="clist"> There are several types of C++, including supervised learning, unsupervised learning, and reinforcement learning. Supervised learning involves training a model on labeled data, while unsupervised learning involves training a model on unlabeled data. Reinforcement learning involves training a model through trial and error. C++ is used in a wide variety of applications, including image and speech recognition, natural language processing, and recommender systems.</li>
        <img src="https://qph.fs.quoracdn.net/main-qimg-10e50e2da62cca6dede231a97128aad4" alt="AI" class="cimg1">
        <p class="high">Definition of Learning:</p>
        <li class="clist">A computer program is said to learn from experience E with respect to some class of tasks T and performance measure P, if its performance at tasks T, as measured by P, improves with experience E. </li>
        
        <p class="high1">Example :</p>
        <li class="clist">Handwriting recognition learning problem</li>
        <li class="clist">A robot driving learning problem</li>

        <p class="ccontent"><span class="high">Definition :  </span>A computer program which learns from experience is called a C++ program or simply a learning program . </p>
        <p class="ccontent1"><b>Video Reference :  </b></p>
        <iframe class="cvideo" src="https://www.youtube.com/embed/ukzFI9rgwfU"></iframe>
            <div class="nbutton">
            <?php
            $user_id = $user_id;
            $course_id = 2;
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 20) {
                    ...
                    // Display the "Next" button
                    echo '<a href="C++_Types.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
