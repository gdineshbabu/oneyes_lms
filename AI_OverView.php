...
<htAI lang="en">
    <head>
        ...
        <title>ONEYES_AI_OVERVIEW</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
...
<output for="percentage1" id="output1"><?php echo $fetched['progress']; ?>%</output>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    echo '
                    <a href="#" class="completed_c">Complete AI</a>
                    ';
                } else {
                    // Display the "Next" button
                ...
                if ($progress < 100) {
                    ...
                    // Display the "Next" button
                    echo '<a href="AI_Overview.php" class="active">Over View<br><span class="small">Completed</span></a>';
                }
            }
            ?>
