...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: ML_OverView.php");
        exit();
    } else {
        // Handle the error
...
<html lang="en">
    <head>
        ...
        <title>ONEYES_ML_COMPLETED</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    echo '
                    <a href="#" class="active">Complete ML<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="ML_Complete.php" class="active">Complete ML<br><span class="small">Completed</span></a>';
                }
                if ($progress < 100) {
                    echo '
                    <a href="#">Over View</a>
...
Congratulations 💐
        ...
        <h1 class="course">Machine Learning</h1>
        ...
        <p class="quote">"Life itself is your teacher, and you are in a state of constant learning."</p>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_OverView.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
