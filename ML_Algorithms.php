...
<html lang="en">
    <head>
        ...
        <title>ONEYES_ML_ALGORITHMS</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 70) {
                    echo '
                    <a href="#" class="active">Algorithms of ML<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="ML_Algorithms.php" class="active">Algorithms of ML<br><span class="small">Completed</span></a>';
                }
        ...
        <h2 class="subhead">Algorithms of Machine Learning :</h2>

        <p class="ccontent">Machine Learning algorithms are the programs that can learn the hidden patterns from the data, predict the output, and improve the performance from experiences on their own. Different algorithms can be used in machine learning for different tasks, such as simple linear regression that can be used for prediction problems like stock market prediction, and the KNN algorithm can be used for classification problems.</p>

        <p class="ccontent">In this topic, we will see the overview of some popular and most commonly used machine learning algorithms along with their use cases and categories.</p>
        <img src="https://th.bing.com/th/id/OIP.lcWvzmxbLwJbREpRXJIeFQHaEK?pid=ImgDet&rs=1" alt="ML" class="cimg1">
        <h1 class="high">Types of Machine Learning Algorithms :</h1>
        <p class="ccontent">Machine Learning Algorithm can be broadly classified into three types:</p>
        ...
        <h1 class="subhead">List of Popular Machine Learning Algorithm</h1>
        ...
        <li class="clist">10. <span class="high1">PCA</span></li>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 70) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_Mcq.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
