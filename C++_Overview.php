...
<html lang="en">
    <head>
        ...
        <title>ONEYES_C++_OVERVIEW</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    echo '
                    <a href="#" class="completed_c">Complete C++</a>
                    ';
                } else {
                    // Display the "Next" button
                ...
                if ($progress < 100) {
                    ...
                    // Display the "Next" button
                    echo '<a href="C++_Overview.php" class="active">Over View<br><span class="small">Completed</span></a>';
                }
            }
            ?>
