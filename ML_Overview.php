...
<htML lang="en">
    <head>
        ...
        <title>ONEYES_ML_OVERVIEW</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 100) {
                    echo '
                    <a href="#" class="completed_c">Complete ML</a>
                    ';
                } else {
                    // Display the "Next" button
                ...
                if ($progress < 100) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_Overview.php" class="active">Over View<br><span class="small">Completed</span></a>';
                }
            }
            ?>
