...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: ML_Algorithms.php");
        exit();
    } else {
        // Handle the error
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 60) {
                    echo '
                    <a href="#" class="active">Goals of ML<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="ML_Goals.php" class="active">Goals of ML<br><span class="small">Completed</span></a>';
                }
        ...
        <iframe class="cvideo" src="https://www.youtube.com/embed/ofM8LE9Zeaw"></iframe>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 60) {
                    ...
                    // Display the "Next" button
                    echo '<a href="ML_Algorithms.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
