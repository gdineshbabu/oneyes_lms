...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: DS_Applications.php");
        exit();
    } else {
        // Handle the error
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 30) {
                    echo '
                    <a href="#" class="active">Types of DS<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="DS_Types.php" class="active">Types of DS<br><span class="small">Completed</span></a>';
                }
        ...
        <h2 class="subhead">Types of DS :</h2> <br>
        
        <p class="high">Qualitative Data</p>
        <p class="high1">Nominal data</p>
        <li class="clist">Gender</li>
        <li class="clist">Colour</li>
        <li class="clist">Ethnicity</li>
        <img src="https://i0.wp.com/intellspot.com/wp-content/uploads/2018/08/Types-of-Data-Infographic.png?resize=680%2C505" alt="AI" class="cimg1">
        
        
        <p class="high1">Ordinal data</p>
        <li class="clist">first,Second,Third</li>
        <li class="clist">Letter</li>
        <li class="clist">Economic</li>

        <p class="high1">Discrete Data</p>
        <li class="clist">Gender</li>
        <li class="clist">Colour</li>
        <li class="clist">Ethnicity</li>

 
        <p class="high1">Continuous data</p>
        <li class="clist">Gender</li>
        <li class="clist">Colour</li>
        <li class="clist">Ethnicity</li>

        <p class="ccontent1"><b>Video Reference :  </b></p>
        <iframe class="cvideo" src="https://www.youtube.com/embed/LdxcgOpVDWY"></iframe>
            <div class="nbutton">
            <?php
            $user_id = $user_id;
            $course_id = 5;
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 30) {
                    ...
                    // Display the "Next" button
                    echo '<a href="DS_Applications.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
