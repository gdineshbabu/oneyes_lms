...
if (isset($_POST['increase_progress'])) {
    ...
    if ($result) {
        header("Location: C++_Assignment.php");
        exit();
    } else {
        // Handle the error
...
<html lang="en">
    <head>
        ...
        <title>ONEYES_C++_DISADVANTAGES</title>
        <!-- Font Awesome Icons -->
    <link
    rel="stylesheet"
    ...
    <body>
        ...
        <?php
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 80) {
                    echo '
                    <a href="#" class="active">C++ DisAdvantages<br><span class="small">Current</span></a>
                    ';
                } else {
                    // Display the "Next" button
                    echo '<a href="C++_Mcq.php" class="active">C++ DisAdvantages<br><span class="small">Completed</span></a>';
                }
                if ($progress < 90) {
                    echo '
                    <a href="#">Assignment</a>
        ...
        <div class="main">
        <h1 class="chead">C++</h1>
        <h2 class="subhead">Advantages of C++(C++) :</h2> <br>
        ...
        <img src="https://electricalfundablog.com/wp-content/uploads/2020/01/Advantages-and-Disadvantages-of-Machine-Learning.png" alt="C++" class="cimg1">
        <h2 class="subhead">DisAdvantages of C++(C++) :</h2> <br>
        ...
        <iframe class="cvideo" src="https://www.youtube.com/embed/kJqg1HvnRss"></iframe>
            ...
            if(mysqli_num_rows($selected) > 0){
                ...
                if ($progress < 80) {
                    ...
                    // Display the "Next" button
                    echo '<a href="C++_Assignment.php"><button class="nbutton1" type="button">Next</button></a>';
                }
            }
            ?>
            </div>
